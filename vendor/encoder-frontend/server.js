const configs = {
    ...
    'esbuild': {
        'entryFile': 'src/application.jsx',
        'outFile': '../../app/assets/encoder-frontend/encoder-application.js'
    },
    'sass': {
        'entryFile': 'stylesheets/application.scss',
        'outFile': '../../app/assets/encoder-frontend/encoder-application.css'
    },
    // 'tail': {
...
console.log('start-server> all:builds');
buildStyleSass();
buildJsEsbuild();
// buildStyleTail();
...
function buildJsEsbuild() {
    console.log('build:js:esbuild> start')
    ...
    console.log('build:js:esbuild> end')
}
...
function buildStyleTail() {
    console.log('build:style:tail> start')
    ...
    // sleep(1000);
    console.log('build:style:tail> end');
}
